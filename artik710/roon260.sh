...
# bash <(curl -s  https://raw.githubusercontent.com/parkmino/audiophile/master/artik710/roon260.sh)
# bash <(curl -sL https://bit.ly/46LbNKj)

mv /opt/RoonBridge/Bridge/RoonBridge /opt/RoonBridge/Bridge/RoonBridge.tweak
[ ! -d /root/copy ] && mkdir /root/copy
wget --no-check-certificate -O /root/copy/RoonBridge_linuxarmv8.tar.bz2 https://download.roonlabs.net/builds/RoonBridge_linuxarmv8_206001501.tar.bz2
