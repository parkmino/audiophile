...
#bash <(curl -s  https://raw.githubusercontent.com/parkmino/audiophile/master/artik710/patch210410.sh)
#bash <(curl -sL https://bit.ly/3dWASq6)
...
sed -i 's/[0-9]*$/210410/' /etc/release
