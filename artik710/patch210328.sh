...
#bash <(curl -s  https://raw.githubusercontent.com/parkmino/audiophile/master/artik710/patch210328.sh)
#bash <(curl -sL https://bit.ly/31sElqg)
...
sed -i 's/229978/229997/g; s/388287/388318/g; s/1394065/1394087/g; s/4899005/4899028/g; s/4604 88254 3345671/4613 88279 3345699/g; s/4528 89899 3455599/4546 89930 3455679/g' /etc/sysctl.conf

### 6. Update Release

cp /etc/release /etc/release.sav
sed -i 's/[0-9]*$/210328/' /etc/release
