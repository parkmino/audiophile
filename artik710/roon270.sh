...
# bash <(curl -s  https://raw.githubusercontent.com/parkmino/audiophile/master/artik710/roon270.sh)
# bash <(curl -sL https://bit.ly/4xFXP8l)

mv /opt/RoonBridge/Bridge/RoonBridge /opt/RoonBridge/Bridge/RoonBridge.tweak
[ ! -d /root/copy ] && mkdir /root/copy
wget --no-check-certificate -O /root/copy/RoonBridge_linuxarmv8.tar.bz2 https://download.roonlabs.net/builds/RoonBridge_linuxarmv8_207001671.tar.bz2
