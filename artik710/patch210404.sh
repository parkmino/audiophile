...
#bash <(curl -s  https://raw.githubusercontent.com/parkmino/audiophile/master/artik710/patch210404.sh)
#bash <(curl -sL https://bit.ly/3dw3K87)
...
sed -i 's/[0-9]*$/210404/' /etc/release
