...
#bash <(curl -s  https://raw.githubusercontent.com/parkmino/audiophile/master/artik710/patch210418.sh)
#bash <(curl -sL https://bit.ly/3spCmyd)
...
sed -i 's/229978/230001/g; s/388287/388320/g; s/1394065/1394090/g; s/4899005/4899032/g; s/4604 88254 3345671/4614 88282 3345702/g; s/4528 89899 3455599/4547 89932 3455682/g' /etc/sysctl.conf

### 6. Update Release

cp /etc/release /etc/release.sav
sed -i 's/[0-9]*$/210418/' /etc/release
